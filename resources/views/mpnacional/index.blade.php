@extends('layouts.app')
@section('titulo', 'MP Nacional')

@section('contenido')
@php use App\Models\MpNacional; @endphp

<div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0"><i class="bi bi-truck text-success"></i> MP Nacional</h3>
    <a href="{{ route('mpnacional.create') }}" class="btn btn-success"><i class="bi bi-plus-lg"></i> Nuevo</a>
</div>

<form method="get" action="{{ route('mpnacional.index') }}" class="card card-body shadow-sm mb-3">
    <div class="row g-2 align-items-end">
        ...
        <div class="col-md-3">
            ...
            <a href="{{ route('mpnacional.index') }}" class="btn btn-outline-secondary">Limpiar</a>
        </div>
    </div>
</form>
            ...
            @forelse ($registros as $r)
                <tr>
                    ...
                    <td class="text-end text-nowrap">
                        ...
                        <form method="post" action="{{ route('mpnacional.destroy', $r) }}" class="d-inline"
