        ...
        <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{ request()->routeIs('reportes-gerenciales.*') ? 'active' : '' }}" href="{{ route('reportes-gerenciales.index') }}">Roberto</a></li>
                        <li><a class="dropdown-item {{ request()->routeIs('pablo.*') ? 'active' : '' }}" href="{{ route('pablo.index') }}">Pablo</a></li>
                    </ul>
                </li>
            </ul>
            <ul class="navbar-nav">
